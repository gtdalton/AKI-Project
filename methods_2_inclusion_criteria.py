...
def inclusion_criteria(data_set, minimum_age=18,min_num_creatinine_readings=2):
    ...
    print ('%s episodes removed as <2 creatinine readings' %(num_episodes - episodes.shape[0]))
